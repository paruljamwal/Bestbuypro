function Header(){
    ...
    <div id="upbox">
        ...
        <p id="nameshow"></p>
            ...
            <div id="logocart"><a href="../newcart/newcart.html"><button id="logocartbtn"><i
    ...
    <div id="lowbox">
        ...
        <div id="lowbox2">
            ...
            <div id="recently"><button id="recently">Viewed<i class="fa-solid fa-chevron-down"></i></button></div>
            <div id="order"><button id="order"> Order<i class="fa-solid fa-chevron-down"></i></button></div>
            <div id="saved"><button id="saved">Saved<i class="fa-solid fa-chevron-down"></i></button> </div>
        </div>
    </div>
</div>`;
}
